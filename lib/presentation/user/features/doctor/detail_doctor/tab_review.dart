...
class _TabReviewState extends State<TabReview> {
  Widget reviewCard(String namaUser, double rating, String description) {
    return Container(
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Reviews (${widget.data.data.totalRating}) ",
                          style: TextStyle(
                            fontSize: 15.sp,
                          ),
                        ),
                        for (var e in widget.data.data.review!)
                          reviewCard(e.namaUser, double.parse(e.rate),
                              e.reviewDescription),
                      ],
                    ),
                  ),
