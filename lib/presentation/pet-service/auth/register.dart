...
class RegisterPetService extends StatefulWidget {
  const RegisterPetService({super.key});

  @override
  State<RegisterPetService> createState() => _RegisterPetServiceState();
}

class _RegisterPetServiceState extends State<RegisterPetService> {
                          ...
                          children: [
                                    ...
                                    RichText(
                                      text: TextSpan(
                                          ...
                                          children: const [
                                            TextSpan(
                                                text:
                                                    "Register your pet service account ",
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontWeight:
                                                        FontWeight.w300)),
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Image.asset(
                                  "assets/pet-service/register/register.png",
                                  height: 45.w,
                                  fit: BoxFit.contain,
                                ),
                              ),
